...
type Hello struct {
	ComputeCapability float32 `protobuf:"fixed32,2,opt,name=ComputeCapability,proto3" json:"ComputeCapability,omitempty"`
}
...
func (m *Hello) GetComputeCapability() float32 {
	if m != nil {
...
type Register struct {
	ComputeCapability float32 `protobuf:"fixed32,1,opt,name=computeCapability,proto3" json:"computeCapability,omitempty"`
}
...
func (m *Register) GetComputeCapability() float32 {
	if m != nil {
		return m.ComputeCapability
	}
	return 0
...
func (this *Hello) Equal(that interface{}) bool {
	...
	if this.ComputeCapability != that1.ComputeCapability {
		return false
	}
	return true
}
...
func (this *Hello) GoString() string {
	...
	s = append(s, "ComputeCapability: "+fmt.Sprintf("%#v", this.ComputeCapability)+",\n")
	s = append(s, "}")
...
var fileDescriptorProtos = []byte{
	...
	,
}
