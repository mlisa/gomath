...
func (m *Hello) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ComputeCapability != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintProtos(dAtA, i, uint64(m.ComputeCapability))
	}
	return i, nil
}
...
func (m *Hello) Size() (n int) {
	...
	_ = l
	if m.ComputeCapability != 0 {
		n += 1 + sovProtos(uint64(m.ComputeCapability))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ComputeCapability |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorProtos = []byte{
	...
	,
}
